...
namespace Capstone.Web.App_Start
{
    ...
    public static class NinjectWebCommon 
    {
        ...
        {
            kernel.Bind<GolfSqlDal>().To<GolfSqlDalImp>().WithConstructorArgument("connectionString", ConfigurationManager.ConnectionStrings["golfdb"].ConnectionString);
        }
    }
}
